...
try:
    ...
    for img_name in progress(img_names):
        ...
        try:
            ...
            for anchor in anchors:
                ...
                image_copy.crop(anchor[1]).save(save_path + f"/cut_results/{crop_name.strip('.jpg')}-{anchor[0]}.jpg")
    ...
    skt.connect(('127.0.0.1', 40001))
    
    while True:
        data = 'ok1'+save_path+"/summary.txt"
        # 向服务器发送数据
