...
class CCasesMgrWnd;
class CMainDlgWnd;
class CMenuWndRight : public CWindowWnd, public INotifyUI
{
public:
    CMenuWndRight() : m_pOwner(NULL), m_pShadowWnd(NULL) { };
	void setXmlFile(CString xml){ m_xmlFile = xml; }
    void Init(CControlUI* pOwner, POINT pt, HWND wnd) {
	...
	void Init(CMainDlgWnd* pOwner, POINT pt, HWND wnd);
    ...
    LPCTSTR GetWindowClassName() const { return _T("MenuWndRight"); };
    void OnFinalMessage(HWND /*hWnd*/) { delete this; };
    ...
    LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
		...
		CControlUI* pRoot = builder.Create(m_xmlFile.GetString(), (UINT)0, NULL, &m_pm);
